...
class CreateClassViewController: UIViewController {
    ...
    // cell meeting title
    @IBOutlet weak var textFieldMeetingTitle: UITextField!
    ...
    @IBOutlet weak var switchPublicMeeting: UISwitch!
    ...
    func collectDataEntered() -> Void {
        ...
        let params = [ "action" : "scheduleMeeting",
                     ...
                     //  "emailList" : attendeesEmail,  //remove this emailList -attendeesEmail
