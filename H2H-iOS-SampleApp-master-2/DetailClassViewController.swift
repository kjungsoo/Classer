...
class DetailClassViewController: UIViewController {
    ...
    func buttonJoinMeetingClicked() {
        ...
        if self.textFieldEmail != "" && self.textFieldMeetingID != ""
        {
            ...
            self.joinMeetingWithEmailOnly(self.textFieldMeetingID, email: self.textFieldEmail, fromViewController: self)
        }
    }
